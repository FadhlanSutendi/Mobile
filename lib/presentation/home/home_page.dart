                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                _SummaryItem(
                                  imagePath:
                                      'assets/atas.png', // pakai image upload
                                  label: "Reuse",
                                  value: "${card.reuse}", icon: null,
                                ),
                                _SummaryItem(
                                  imagePath:
                                      'assets/bawah.png', // pakai image download
                                  label: "Consum",
                                  value: "${card.used}", icon: null,
                                ),
                                _SummaryItem(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () =>
                                Get.toNamed(AppRoutes.historyPeminjaman),
                            child: Text(
                              "See All",
                              style: GoogleFonts.poppins(
                                color: Colors.blue,
...
class _SummaryItem extends StatelessWidget {
  ...
  final String? imagePath; // image optional
  final String label;
  final String value;
        ...
        CircleAvatar(
          ...
          child: imagePath != null
              ? Image.asset(
                  ...
                  width: 20,
                  height: 20,
                  color: Colors.white, // kalau mau putih
                )
    ...
    return Row(
      children: [
        Image.asset(
          ...
          height: 14,
          fit: BoxFit.contain,
          color: const Color(0xFF545454), // hapus kalau mau warna asli png
        ),
        const SizedBox(width: 6),
        Text(
          label,
